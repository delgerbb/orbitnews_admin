...
$config = array(
     ...
     */
     ...
     'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && !in_array(strtolower($_SERVER['HTTPS']), array('off', 'no'))) ? 'https' : 'http') . '://' . "mongoliax.mn/", 
    /*'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && !in_array(strtolower($_SERVER['HTTPS']), array('off', 'no'))) ? 'https' : 'http') . '://' . "localhost:8080/mongoliax/",*/
    /*
      |--------------------------------------------------------------------------
      ...
      |
     */
    'upload_dir' => 'uploads/news/inner_pics/',
    /*
      |--------------------------------------------------------------------------
      ...
      |
     */
	/*'current_path' => $_SERVER['DOCUMENT_ROOT'] . '/mongoliax.mn/uploads/news/inner_pics/',*/
    'current_path' => '/home/micronamekhovd/public_html/mongoliax.mn/uploads/news/inner_pics/',
    /*
      |--------------------------------------------------------------------------
